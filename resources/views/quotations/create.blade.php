        ...
        <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="{{ route('quotations.store') }}" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="type_payment_id" id="inlineRadio3"
                            value="3">
                ...
                <div class="col-md-8">
                    <label for="lastPaymentDay"
                        class="form-label @error('last_payment_day') text-danger fw-bold @enderror">
                    ...
                    <div class="input-group @error('last_payment_day') text-danger @enderror">
                        ...
                        <input id="lastPaymentDay" type="date" class="form-control" name="last_payment_day"
                            value="{{ old('last_payment_day') }}"
                            {{ old('no_apply_last_payment_day') ? 'readonly' : '' }}>
                    </div>
                ...
                <div class="col-md-4 d-flex justify-content-center align-items-center">
                    <div class="form-check mt-4">
                        <input class="form-check-input" name="no_apply_last_payment_day" type="checkbox"
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group @error('description') text-danger @enderror">
                        ...
                        <textarea placeholder="Agregue una breve descripción del caso..." name="description"
                            class="form-control @error('description') is-invalid @enderror" id="exampleFormControlTextarea1" rows="2"></textarea>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group @error('comments') text-danger @enderror">
                        ...
                        <textarea placeholder="Agregue una breve descripción del caso..." name="comments"
                            class="form-control @error('comments') is-invalid @enderror" id="exampleFormControlTextarea1" rows="2"></textarea>
                    </div>
                ...
                <div class="text-end">
                    @role('independent-client|company-client|employee|general-admin')
