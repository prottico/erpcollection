<x-layouts.app>
            ...
            <form class="row g-3" method="POST" action="{{route('quotations.store')}}" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group @error('default_interest_rate') text-danger @enderror">
                        ...
                        <input placeholder="Tasa de Interés Moratoria" id="defaultInterestRate" type="text" readonly
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group @error('description') text-danger @enderror">
                        ...
                        <input id="description" type="text" placeholder="Breve descripción del
                        caso" class="form-control @error('description') is-invalid @enderror" name="description"
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        type="radio" name="type_payment_id" readonly
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group ">
                        ...
                        <input id="cost" type="text" placeholder="Determina el costo" readonly class="form-control"
                            name="cost" value="{{old('cost', $quotation->cost)}}">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input id="cost" type="text" placeholder="Determina el costo" readonly class="form-control"
                            name="cost" value="{{$quotation->typeCase->name}}">
                    </div>
                </div>

                <div class="col-md-12">
                    <label for="lawyer_commet" class="form-label"><strong>Comentario del Abogado asignado</strong></label>
                    <div class="input-group">
                        <span class="input-group-text">
                            <i class="ri ri-chat-1-fill"></i>
                        </span>
                        <input id="lawyer_commet" type="text" placeholder="Dejarle un comentario al cliente" readonly
                            class="form-control" name="lawyer_commet" value="{{$quotation->lawyer_commet}}">
                    </div>
                </div>
                @endif
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalAssignLawyer" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="col-12">
                            <form action="{{route('quotations.assign.lawyer')}}" id="dataFormSend" method="POST">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="quotationId" data-req-send value="{{$encryptedId}}">
