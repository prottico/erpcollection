    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="{{route('lawyers.quotations.update', $quotation->token)}}"
                ...
                <div class="col-md-6">
                    <label for="typeCase"
                        class="form-label @error('type_case_id') text-danger fw-bold @enderror"><strong>Determinar tipo
                    ...
                    <div class="input-group @error('type_case_id') text-danger @enderror">
                        ...
                        <select name="type_case_id"
                            ...
                            <option value="{{ $type->id}}" {{ old('type_case_id', $quotation->type_case_id) == $type->id
                                ? 'selected' : '' }}>
                                {{ $type->name }}
                            </option>
                            @endforeach
